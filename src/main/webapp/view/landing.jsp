...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header page-scroll">
            ...
            <a class="navbar-brand page-scroll inverse-shadow" href="#page-top">Welcome to DEPICT</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    <a class="page-scroll inverse-shadow" href="#about">About</a>
                </li>
                <li>
                    <a class="page-scroll inverse-shadow" href="#team">Team</a>
                </li>
                <li>
                    <a class="page-scroll inverse-shadow" href="#contact">Contact</a>
                </li>
                <li>
                    <a class="page-scroll inverse-shadow" href="/login">Login</a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
...
<header>
    <div class="container">
        <div class="intro-text">
            <div class="intro-lead-in shadow">Welcome To Newfoundland and Labrador's</div>
            <div class="intro-heading shadow">DEPICT Project</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading">What is DEPICT?</h2>
                <p style="text-align: justify;">
                    Newfoundland and Labrador experiences some of the highest rates of chronic diseases (for example,
                    diabetes and heart disease) in the country. In 2011, the provincial government released a report
                    highlighting a new policy framework for chronic disease prevention and management which included the
                    need for improved data collection. There is currently no routine system for the analysis of chronic
                    disease data and reporting of evidence-based information for chronic disease management. As a
                    result, this important health information is not always available or accessible to those responsible
                    for monitoring and evaluating chronic disease including researchers, healthcare practitioners, and
                    policymakers. Information systems that routinely collect and organize data can support policy
                    planners and practitioners and ultimately inform chronic disease policy. We propose to collect
                    information about chronic disease from provincial health data sources, perform the linkage, analysis
                    and interpretation of these data, classify the information within time and geographic parameters,
                    and make the results available via a technologically innovative electronic tool. The DEPICT (Digital
                    Epidemiology Chronic Disease Tool) project will place up-to-date and relevant information at the
                    fingertips of chronic disease policymakers, researchers, healthcare practitioners and educators.
                </p>
            </div>
        </div>
        <div class="row text-center">
            <div class="col-md-4">
                ...
                <h4 class="service-heading">Geographic View</h4>
                <p class="text-muted">DEPICT uses the awesome Google Map to show the results in a meaningful manner.</p>
            </div>
            <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                ...
                <p class="text-muted">DEPICT is designed completely resonsive to be able to work flawlessly in various devises from desktop PCs to smartphones.</p>
            </div>
            <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                ...
                <p class="text-muted">DEPICT uses the newest technologies in web to preserve the security and privacy of the users of the application.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <h3 class="section-subheading text-muted">Let's take a look at DEPICT's history</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <ul class="timeline">
                    <li>
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body">
                                <p class="text-muted">We started this project back in 2009...</p>
                            </div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>March 2011</h4>
                                <h4 class="subheading">An Application is Born</h4>
                            </div>
                            <div class="timeline-body">
                                <p class="text-muted">The first version of DEPICT was developed...</p>
                            </div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body">
                                <p class="text-muted">We went online and fully functional, but we steal yearn to evolve... </p>
                            </div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="team-member">
                    ...
                    <h4>Shabnam Asghari</h4>
                    <p class="text-muted">Lead Member</p>
