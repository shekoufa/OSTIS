...
//infowindow.close();
        ...
        function showFeature1(geojson, color, postCode, count, style) {
            ...
            features1.push(currentFeature_or_Features);
            currentFeature_or_Features1.strokeWidth = 10;
        ...
        function showFeature2(geojson, color, postCode, count, style) {
            ...
            features2.push(currentFeature_or_Features);
            currentFeature_or_Features2.strokeWidth = 10;
                            ...
                            <div class="col-xs-9">
                                <div class="col-xs-12"
                                    ...
                                    <div class="col-xs-12" style="padding: 0;">
                                        ...
                                        <div id="timeline">
                                            <ul id="dates">
                                                <li><a onclick="prepareSendRequest(1998);" href="javascript:void(0);">1998</a>
                                                </li>
                                                <li><a onclick="prepareSendRequest(1999);" href="javascript:void(0);">1999</a>
                                                </li>
                                                <li><a onclick="prepareSendRequest(2000);" href="javascript:void(0);">2000</a>
                                                </li>
                                                <li><a onclick="prepareSendRequest(2001);" href="javascript:void(0);">2001</a>
                                                </li>
                                                <li><a onclick="prepareSendRequest(2002);" href="javascript:void(0);">2002</a>
                                                </li>
                                                <li><a onclick="prepareSendRequest(2003);" href="javascript:void(0);">2003</a>
                                                </li>
                                                <li><a onclick="prepareSendRequest(2004);" href="javascript:void(0);">2004</a>
                                                </li>
                                                <li><a onclick="prepareSendRequest(2005);" href="javascript:void(0);">2005</a>
                                                </li>
                                                <li><a onclick="prepareSendRequest(2006);" href="javascript:void(0);">2006</a>
                                                </li>
                                                <li><a onclick="prepareSendRequest(2007);" href="javascript:void(0);">2007</a>
                                                </li>
                                                <li><a onclick="prepareSendRequest(2008);" href="javascript:void(0);">2008</a>
                                                </li>
                                            </ul>
                                            <ul id="issues">
                                            </ul>
                                ...
                                <div class="col-xs-12 text-center">
                                    <ul class="cd-accordion-menu animated">
                                        <li class="has-children">
                                            <input type="checkbox" name="disease_type_chk" id="disease_type_chk"
                                                   checked>
                                        ...
                                        <li class="has-children">
                                            <input type="checkbox" name="comorbidities_chk" id="comorbidities_chk"
                                                   checked>
                                            ...
                                            <ul style="display: none;" class="inner-ul-menu">
                                                ...
                                                <li><a style="text-decoration: none;" class="comorbidity-selector"
                                                       ...
                                                       onclick="handleActivation(this);">Nausia</a></li>
                                                <li><a style="text-decoration: none;" class="comorbidity-selector"
                ...
                <sec:authorize access="hasRole('ROLE_USER')">
                    <div id="tabs-2" style="display: inline-block;margin-top: 10px;width: 100%;">
                        ...
                        <div class="col-xs-12 text-center" style="margin-top:10px;">
                            <input type="button" class="btn btn-lg btn-primary" onclick="sendCompareRequest();" value="Compare"/>
                            <input type="button" class="btn btn-lg btn-warning" onclick="clearMap();" value="Clear Map"/>
                        </div>
...
//                init();
    ...
    function sendCompareRequest(){
        ...
        console.log($("#first_map_select").val());
        console.log($("#second_map_select").val());
        $.ajax({
